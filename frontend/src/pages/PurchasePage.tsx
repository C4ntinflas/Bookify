...
let newImg: string | undefined = undefined;
let setPrice: string | null = null;
let book: Book | null = null;

function setImg(array: { name: string; img: string; price: string }[], book: Book) {
...
function PurchasePage() {
    ...
    const { from } = location.state as { from: Book };
            ...
            <div className='containerMain'>
                <div className='bookContainer'>
                    ...
                    <div className='bookDetails'>
                        ...
                        <h3 className="bookGenre">Description</h3>
